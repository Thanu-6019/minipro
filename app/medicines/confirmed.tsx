...
export default function MedicationConfirmation() {
  ...
  useEffect(() => {
    ...
    // Card Animation (delay-100 floatUp)
    ...
    // Buttons Animation (delay-200 floatUp)
  ...
  }, [scaleAnim, opacityAnim, cardOpacity, cardTranslate, btnOpacity, btnTranslate]);
          ...
          >
            ...
            <View style={styles.cardHeader}>
              ...
              <View style={styles.medInfoContainer}>
                <Text style={styles.medName}>{name || 'Medicine'}</Text>
                <Text style={styles.medDetails}>{dosage || ''}</Text>
              </View>
            </View>
            ...
            <View style={styles.detailsContainer}>
              <View style={styles.detailRow}>
                ...
                <Text style={styles.detailValue}>{frequency || 'As prescribed'}</Text>
              </View>
              <View style={styles.detailRow}>
